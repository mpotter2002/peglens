# xStockLens — recording checklist

~60–90 seconds. Record against the live deploy; local is the fallback.

**Live demo:** [https://xstocklens.vercel.app](https://xstocklens.vercel.app) (production build of `main`, no API keys).

## Setup

Open [https://xstocklens.vercel.app](https://xstocklens.vercel.app). Fallback: `npm install && npm run dev` → [http://localhost:3000](http://localhost:3000).
...
| # | Shot | Look for |
| --- | --- | --- |
| 1 | Land on [xstocklens.vercel.app](https://xstocklens.vercel.app) | **Most popular** list is the home. **Hosted** (or **Local / test**) + **Not a broker**. |
...
- Any hosted URL other than xstocklens.vercel.app
