...
export class BoardComposer {
  ...
  static honestRoute(
    ...
    const caveat = claimCheapest
      ? "Indicative quote for $100 USDC in, 0.5% slippage. xStockLens never fills or signs."
      : `Indicative ${venueName} quote for $100 USDC in, 0.5% slippage. Not a cheapest claim — xStockLens only heard one venue. Never fills or signs.`;
    return {
